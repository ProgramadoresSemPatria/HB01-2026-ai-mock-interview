  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div className="min-w-0 flex-1">
        <p className="manrope text-[10px] font-medium uppercase tracking-widest text-neutral-500">
          {label}
        </p>
        <p className="manrope mt-0.5 text-sm text-white">{value}</p>
      </div>
    </div>
  );
}
...
export function InterviewSessionSidebar({
  ...
  return (
    <aside className="interview-chat-demo__sidebar flex w-full shrink-0 flex-col border-b border-white/15 md:w-[280px] md:border-b-0 md:border-r">
      <div className="flex flex-1 flex-col p-6">
        <p className="manrope text-[10px] font-medium uppercase tracking-widest text-neutral-500">
          Interview Session
        </p>
        <h3 className="instrument-serif mt-2 text-3xl font-normal text-white md:text-4xl">
          {meta.level}
        </h3>
        ...
        <div className="mt-6 pt-4 md:mt-auto md:pt-8">
          <div className="border border-white/15 p-4">
            <div className="flex items-center gap-2">
              <Circle className="size-2.5 fill-neutral-500 text-neutral-500" />
              <span className="manrope text-[10px] font-medium uppercase tracking-widest text-neutral-500">
                Context
              </span>
            </div>
            <p className="manrope mt-3 text-xs leading-relaxed text-neutral-400">
              {contextText}
            </p>
          </div>
        </div>
