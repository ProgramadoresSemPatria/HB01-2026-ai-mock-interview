...
10. [Respostas fracas (weak answers)](#respostas-fracas-weak-answers)
11. [Erros HTTP](#erros-http)
12. [CORS e limitações](#cors-e-limitações)
13. [Sugestão de estados na UI](#sugestão-de-estados-na-ui)
